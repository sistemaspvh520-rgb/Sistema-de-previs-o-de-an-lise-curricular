...
export function PoloReportCard({
  ...
  return (
    <Card className={className}>
      <CardHeader className="flex flex-row flex-wrap items-center justify-between gap-3 space-y-0 border-b border-brand-cyan/20 bg-brand-cyan-50/70">
        <div>
          <CardTitle className="flex items-center gap-2 text-base">
            <MapPin className="size-4 text-brand-cyan-700" /> {title}
          </CardTitle>
          {description && (
        ...
        {rows.length === 0 ? (
          ...
          <div className="divide-y">
            ...
            {rows.map((row) => (
              <div
                key={row.code}
                className="grid gap-2 border-l-4 border-transparent px-4 py-3 text-sm transition-colors hover:border-brand-cyan hover:bg-white/70 sm:grid-cols-[minmax(0,1fr)_5rem_5rem_5rem_6rem] sm:items-center sm:gap-3 sm:px-6"
              >
                ...
                <div className="flex gap-4 text-xs sm:contents">
                  <span className="sm:text-right">
                    ...
                    <span className="font-semibold text-brand-navy sm:text-sm">
                      {row.total}
                    </span>
                  </span>
                  <span className="sm:text-right">
                  ...
                  <span className="text-status-success sm:text-right">
                ...
                <a
                  ...
                  download
                  className="text-xs text-brand-cyan-700 underline sm:text-right"
                >
                  Exportar
                </a>
              </div>
